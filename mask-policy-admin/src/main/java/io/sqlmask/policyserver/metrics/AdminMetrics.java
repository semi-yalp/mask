 ...
 * wrap so a failed audit and a failed metric coincide (spec §5.1).
 */
@Component("policyAdminMetrics")
public class AdminMetrics {
   ...
   * 与 {@link RewriteMetrics#duration} 同样做法：把 {@link RewriteMetrics#sloSeconds()}

...
public class PolicyExchangeController {
  ...
  public PolicyExchangeController(PolicyService service, @org.springframework.beans.factory.annotation.Qualifier("policyAuditAdminHelper") AuditAdminHelper audit,

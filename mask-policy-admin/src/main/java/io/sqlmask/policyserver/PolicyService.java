...
public class PolicyService {
  ...
  /** Current config version; moves on every policy/UDF/structure mutation.
   * In-process consumers stamp their caches with it to invalidate instantly. */
...
/** Outcome of a policies.yaml import: how many policies were created vs updated. */
   ...
   */
  public synchronized ImportResult importPolicies(String instanceName, String yaml) {
    requireInstance(instanceName);

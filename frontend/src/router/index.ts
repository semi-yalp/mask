  ...
  routes: [
    ...
    },
    {
      ...
      children: [
        ...
        { path: "classification", name: "classification", component: () => import("@/views/classification/ClassificationView.vue") },
        { path: "policy-manager/:name", name: "policy-manager", component: () => import("@/views/policymanager/PolicyManager.vue"), props: true },
        { path: "grants", name: "grants", component: () => import("@/views/grants/GrantsView.vue") },
